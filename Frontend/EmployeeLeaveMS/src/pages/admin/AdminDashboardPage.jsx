...
export default function AdminDashboardPage() {
  ...
  const cards = [
    ...
    { label: 'Leave Types', value: '—', icon: '🗂️', color: 'bg-green-50', path: '/admin/leave-types' },
    { label: 'All Leave Requests', value: '—', icon: '📋', color: 'bg-orange-50', path: '/admin/leaves' },
  ]
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="flex flex-col gap-3">
            {[
              { label: 'Assign Leave Balance', path: '/admin/employees', icon: '📊' },
